        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(currentPosition == null){
                    Toast.makeText(MapActivity.this, "잠시만 기다려 주세요", Toast.LENGTH_SHORT).show();
                }
                else{
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mGoogleMap.setOnMarkerClickListener(new GoogleMap.OnMarkerClickListener() {
            ...
            public boolean onMarkerClick(Marker marker) {
                ...
                returnIntent.putExtra("name",marker.getTitle());
                returnIntent.putExtra("loc",marker.getSnippet());
...
//    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if(requestCode == PLACE_PICKER_REQUEST && resultCode == Activity.RESULT_OK){
            final Place place = PlacePicker.getPlace(MapActivity.this, data);
            final CharSequence name = place.getName();
            final CharSequence address = place.getAddress();

            Intent returnIntent = new Intent();
            returnIntent.putExtra("name",name.toString());
            returnIntent.putExtra("loc",address.toString());
            setResult(Activity.RESULT_OK,returnIntent);
            finish();
